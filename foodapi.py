...
class food_api(object):
    ...
    no_result = ["Actually no... there's something wrong with your typing. Please type 'eatntu' to restart"]
    ...
    headers_yummly = {0: "recipeName", 1: ["id","Recipe directions"], 2: ["smallImageURLs","Image"], 3: ["ingredients","Ingredients"], 4: ["totalTimeInSeconds","Time needed"], 5: ["flavors","Flavours"], 6: ["rating","Rating"]}
