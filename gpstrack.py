...
def main(): #YOU CAN RUN THIS AND SEE...
	...
	while termm == True:
		...
		# print(google_maps.excel_to_list("Canteen Restaurant List.xlsx", "placeid"))
		# destination_text = input('enter destination(in the list): ')
		# destination = google_maps.canteen_latlng("Canteen Restaurant List.xlsx", "placeid", destination_text)	
